...
# -------------------------------
rec_options = sorted(df_filtered['Рекомендация'].unique())
selected_recs = st.sidebar.multiselect("Фильтр по рекомендации", rec_options, default=rec_options)
df_filtered = df_filtered[df_filtered['Рекомендация'].isin(selected_recs)]
